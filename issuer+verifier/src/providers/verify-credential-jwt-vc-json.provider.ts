    ...
    async verify(vc): Promise<boolean> {
      ...
      if (iss && typeof iss === 'string') {
        ...
        try {
          ...
          console.error('  VC issuer:', iss)
          console.error('  VC kid:', decodedJwtVc.header.kid)
          console.error('  VC alg:', decodedJwtVc.header.alg)
          console.error('  Public JWK used:', JSON.stringify(publicJwk))
